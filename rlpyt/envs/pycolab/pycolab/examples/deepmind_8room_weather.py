...
1: [[5, 18], [5, 19], [5, 20], [5, 21], [5, 22], [5, 23], [6, 18], [6, 19], [6, 20], [6, 21], [6, 22], [6, 23], [7, 18], [7, 19], [7, 20], [7, 21], [7, 22], [7, 23], [8, 18], [8, 19], [8, 20], [8, 21], [8, 22], [8, 23], [9, 18], [9, 19], [9, 20], [9, 21], [9, 22], [9, 23], [10, 18], [10, 19], [10, 20], [10, 21], [10, 22], [10, 23], [11, 18], [11, 19], [11, 20], [11, 21], [11, 22], [11, 23]], 
...
class PlayerSprite(prefab_sprites.MazeWalker):
  ...
  def update(self, actions, board, layers, backdrop, things, the_plot):
    ...
    elif ((br-2) <= pr <= (br+2)) and ((bc-2) <= pc <= (bc+2)):
      the_plot.add_reward(self.b_reward)
    elif ((cr-2) <= pr <= (cr+2)) and ((cc-2) <= pc <= (cc+2)):
      the_plot.add_reward(self.c_reward)
    elif ((dr-2) <= pr <= (dr+2)) and ((dc-2) <= pc <= (dc+2)):
      the_plot.add_reward(self.d_reward)
    elif ((er-2) <= pr <= (er+2)) and ((ec-2) <= pc <= (ec+2)):
      the_plot.add_reward(self.e_reward)
    elif ((fr-2) <= pr <= (fr+2)) and ((fc-2) <= pc <= (fc+2)):
      the_plot.add_reward(self.f_reward)
    elif ((gr-2) <= pr <= (gr+2)) and ((gc-2) <= pc <= (gc+2)):
      the_plot.add_reward(self.g_reward)
    elif ((hr-2) <= pr <= (hr+2)) and ((hc-2) <= pc <= (hc+2)):
